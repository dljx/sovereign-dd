...
# Shared with gems.py via pipeline_io (aliased to keep this module's existing
# API — main.py and the tests import these names from scout).
from pipeline_io import atomic_write_text as _atomic_write_text
from pipeline_io import load_ledger as _load_ledger
            ...
            try:
                ...
                if verbose:
                    ...
                    if score >= BUY_THRESHOLD:
                        ...
                        # Surface the underlying error for UNVERIFIED so a broken
                        # verifier is diagnosable from the CI log alone.
